...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_user', 'activation_key',
                      self.gf('django.db.models.fields.CharField')(default=u'<function uuid4 at 0x1820d70>', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.activation_key'
        db.delete_column(u'accounts_user', 'activation_key')


    models = {
        u'accounts.user': {
            'Meta': {'object_name': 'User'},
            'activation_key': ('django.db.models.fields.CharField', [], {'default': "u'<function uuid4 at 0x1820d70>'", 'max_length': '200'}),
