...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('cidade', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('logradouro', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
